...
from experiments.reasoning.power_sampling_reasoning.grader_utils.he_grader import entry_point, extract_code
...
def fnames_to_json(
    ...
    output_fname,
    tag,
    data_file="/m/home/home0/00/scheufh1/data/Documents/temperature_diffusion/reasoning_experiments/data/HumanEval.jsonl/human-eval-v2-20210705.jsonl",
):
...
def he_results(fnames, output_fname):
    ...
    for tag in tags:
        ...
        entry_point(
            output_file,
            problem_file="/m/home/home0/00/scheufh1/data/Documents/temperature_diffusion/reasoning_experiments/data/HumanEval.jsonl/human-eval-v2-20210705.jsonl",
        )
