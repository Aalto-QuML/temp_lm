...
# Monkeypatch for attention mask dtype issue - removed, use standard implementation
# The standard transformer implementation should handle this correctly
...
if __name__ == "__main__":
    ...
    if model == "qwen":
        ...
        # tokenizer_str = "Qwen/Qwen2.5-7B"
    elif model == "qwen_math":
        model_str = "Qwen/Qwen2.5-Math-7B"
        # tokenizer_str = "Qwen/Qwen2.5-Math-7B"
    elif model == "qwen_math_grpo":
        model_str = "stellalisy/rethink_rlvr_reproduce-ground_truth-qwen2.5_math_7b-lr5e-7-kl0.00-step150"
        # tokenizer_str = "stellalisy/rethink_rlvr_reproduce-ground_truth-qwen2.5_math_7b-lr5e-7-kl0.00-step150"
    elif model == "phi":
        model_str = "microsoft/Phi-3.5-mini-instruct"
        # tokenizer_str = "microsoft/Phi-3.5-mini-instruct"
    elif model == "tulu":
        model_str = "allenai/Llama-3.1-Tulu-3-8B-DPO"
        # tokenizer_str = "allenai/Llama-3.1-Tulu-3-8B-DPO"
    else:
    ...
    tokenizer = transformers.AutoTokenizer.from_pretrained(
        model_str, trust_remote_code=use_remote_code
    )
    ...
    df.to_csv(
        os.path.join(
            ...
            # + str(temp)
            # + "_"
            + str(args.batch_idx) + "_" + str(args.seed) + ".csv",
        ),
        index=False,
    )
